    ...
    return (
        <div className="fixed bottom-5 left-5 z-40 flex items-center gap-3">
            ...
            >
                ...
                <span className="absolute top-1/2 left-1/2 w-10 h-10 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#f94804] opacity-30 slow-ping"></span>

                {/* Profile Image */}
                <img
                    src="./profile.png"
                    alt="LinkedIn"
                    className="w-12 h-12 rounded-full object-cover border-2 border-white shadow relative z-10"
                />

                {/* LinkedIn Icon */}
                <span className="absolute bottom-0 right-0 bg-white p-0.5 rounded-full shadow z-20">
                    <svg
